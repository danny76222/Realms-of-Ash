...
export const CHARACTERS: Record<string, CharacterProfile> = {
  ...
  lord_corvane: C({
    ...
    speech:
      "Short declarative sentences. Speaks in costs and ledgers, never in glory. Pauses before agreeing to anything.",
    voice: { pitch: 0.72, rate: 0.88, prefer: "male", hints: ["daniel", "arthur", "george"] },
    lines: {
      hostile:
        '"I have a list of people who cost me men. You are on it, and the list is not long."',
      cold: '"Say your piece standing. I have three hours of grain returns and none of them lie to me."',
      neutral:
        '"You want my banners. Everyone wants my banners. Tell me what they buy and I will consider it."',
      warm: '"Sit. There is bread. What I owe you is more than bread, but the treasury and I disagree about that."',
      devoted:
        '"When this is finished, Ravensfell will remember your name longer than mine. I have made arrangements."',
    },
  }),
  lady_seren: C({
    backstory:
    ...
    speech:
      "Clipped, precise, faintly amused. Answers questions with better questions. Compliments arrive disguised as logistics.",
    ...
    lines: {
      ...
      neutral:
        '"Two hundred spears, four days\' march, one bridge that will not hold them. Now. You were saying something about courage?"',
      warm: '"I have started planning around you rather than despite you. Take that as the flattery it is."',
      devoted:
        '"I do not say fond things well. So: I have moved my reserve to wherever you intend to be. Read into that."',
    },
  }),
  bram_carter: C({
    backstory:
    ...
    speech:
      "Warm, rambling, self-interrupting. Country turns of phrase, jokes that land two sentences late.",
    voice: { pitch: 0.95, rate: 1.05, prefer: "male", hints: ["fred", "alex"] },
    lines: {
      hostile:
        '"I gave you a ride once. I have thought about that a fair bit since, and not fondly."',
      cold: '"Axle\'s gone again. So has my good opinion, near enough. Mind the ruts."',
      neutral:
        "\"Roads are bad, tolls are worse, and there's a fellow at Millford selling cheese he calls Ravensfell. It isn't.\"",
      warm: '"There you are! I told the whole tap-room about you. Improved it a bit. Only a bit."',
      devoted:
        "\"Anything on this cart is yours, and if it's not on the cart I'll go and get it. That's the whole speech, I practised it.\"",
    },
  }),
  sister_dulcie: C({
    backstory:
    ...
    speech:
      "Motherly warmth wrapped around brutal frankness. Blesses you and criticises you in the same breath.",
    ...
    lines: {
      ...
      neutral:
        '"You are eating badly and sleeping worse. The gods notice, and so does your liver."',
  ...
  lord_vantry: C({
    ...
    speech:
      "Silk and arithmetic. Turns every moral question into a price, and apologises charmingly while doing it.",
    ...
    lines: {
      ...
      neutral:
        '"Loyalty, you see, is a subscription, not a purchase. Shall we discuss terms over something amber?"',
      warm: '"For you, favourable rates and no questions. Two favours, really, and the second is the rarer."',
      devoted:
        '"Goldmere\'s coffers answer to you before they answer to me. Do not tell my clerks; they are fragile people."',
    },
  }),
  ser_isolde: C({
    backstory:
    ...
    speech:
      "Soldier's economy. Speaks in terms of duties and hours. Emotion leaks out sideways, then she changes the subject.",
    ...
    lines: {
      ...
      neutral:
        '"Nine years I have held this gate. Give me a reason to stand somewhere else and make it a good one."',
      warm: '"I kept the second flask for you. That is... the watch runs long. That is all that means."',
      devoted:
        '"I would tear up the contract for you. I have never said that to anyone, so kindly do not die."',
    },
  }),
  ...
  lord_draeven: C({
    ...
    speech:
      "Reasonable, unhurried, forge-metaphors. Never raises his voice; treats every objection as a design flaw to be corrected.",
    ...
    lines: {
      ...
      neutral:
        '"They call this usurpation. A smith calls it refitting a handle to an axe that keeps flying off."',
      warm: '"You see it, don\'t you. Not the crown, the crack in it. Few people ever look that closely."',
      devoted:
        '"When they write this down they will need someone to blame. Stand beside me and we will make them spell both names right."',
    },
  }),
  captain_maud: C({
    backstory:
    ...
    speech:
      "Flat, procedural, gallows-dry. Reports rather than converses. Never swears; somehow this is worse.",
    voice: { pitch: 0.82, rate: 0.9, prefer: "female", hints: ["victoria", "tessa"] },
    lines: {
      hostile:
        '"Noted. Filed. When the order comes, it will not be personal, and it will not be slow."',
      cold: '"You are a line item. I have not decided yet in which column."',
      neutral:
        '"Ash Company holds what it is told to hold. That is the arrangement. Sentiment is not in the arrangement."',
      warm: "\"I have written you into my ledger under 'exceptions'. There are two names in that column.\"",
      devoted:
        '"I follow orders until the day I do not. Congratulations, you appear to be the day."',
    },
  ...
  the_fen_widow: C({
    ...
    speech:
      "Gentle, courteous, hostess-warm. Threats phrased as hospitality. Uses your name a great deal.",
    voice: { pitch: 1.28, rate: 0.8, prefer: "female", hints: ["fiona", "serena"] },
    lines: {
      hostile:
        '"Oh, you poor thing. Do drink something. Not that one, obviously. I am fond of you today."',
      ...
      devoted:
        '"If anyone ever moves against you, they will simply stop attending things. Don\'t ask, dear."',
    },
  }),
  ...
  lady_aleyne: C({
    ...
    speech:
      "Courtly formality delivered at a gallop. Compliments are precise; insults are more precise. Hates hedging.",
    voice: { pitch: 1.15, rate: 1.12, prefer: "female", hints: ["serena", "victoria"] },
    lines: {
      hostile:
        '"You are welcome at my table. My table is outside, in the rain, and I shall be eating indoors."',
      cold: '"Be brief and be accurate. I have horses with better sense of occasion than most of my guests."',
      neutral:
        '"Sunmarch does not sell its cavalry. It spends them, on causes it can look at in daylight. Are you one?"',
      warm: '"Ride out with me at dawn. Bring the good cloak; I intend to be seen agreeing with you."',
      devoted:
        '"My house rides where you point. I have told them it is strategy. It is not entirely strategy."',
    },
  }),
  ser_perrin: C({
    backstory:
    ...
    speech:
      "Breathless, delighted, digressive. Everything is a story about someone else, told in confidence, loudly.",
    voice: { pitch: 1.06, rate: 1.18, prefer: "male", hints: ["alex", "fred"] },
    lines: {
      hostile:
        '"I shall say nothing about you. That is the cruellest thing I can do to a person, and I mean it."',
      cold: '"Mm. No, I have nothing for you today. Frightful weather, isn\'t it. Frightful."',
      neutral:
        "\"Vantry's clerk is courting Brannoc's cousin. No, listen, the cousin cannot read, so the letters are being read aloud by a priest.\"",
      warm: '"You get the good version, not the tap-room version. The good version has names in it."',
      devoted:
        '"I would ride into the Black Stair for you, and I would talk the whole way down. That is the deal, take it."',
    },
  }),
  ...
  lord_brannoc: C({
    ...
    lines: {
      ...
      neutral:
        '"Thirty clans. Thirty opinions. I speak for them the way a river speaks for the rain: loudly, and late."',
      warm: '"You keep your word past the point it stops being profitable. That is rare enough that I noticed."',
      devoted:
        '"Thornwold marches. Not for a crown. For you, and I will say so in front of all thirty of them."',
    },
  }),
  hana_of_the_glen: C({
    backstory:
    ...
    speech:
      "Very few words, chosen with care. Long observational pauses. Humour that arrives flat and lands hard.",
    ...
    lines: {
      ...
      neutral:
        '"Two riders on the ridge since midday. They think the gorse hides them. It does not."',
      warm: '"I saved you the good side of the fire. Say nothing about it and we can keep doing that."',
      devoted:
        '"Wherever you go, I will already be up the hill above it. That is what I have instead of a speech."',
    },
  ...
  reeve_ilsa: C({
    ...
    speech:
      "Fast, procedural, deflating. Turns grand speeches into agenda items. Says 'right' a lot before doing something drastic.",
    ...
    lines: {
      ...
      neutral:
        '"No lords here, no titles, no bowing. Just eleven towns, one budget, and a great deal of shouting."',
      warm: '"You are the only titled-adjacent nuisance the Council actually looks forward to. Do not let it go to your head."',
      devoted:
        '"If the realm burns, the Holds hold. With you. And I will get that through the Council if it takes all night. It will take all night."',
    },
  }),
  osrick_quill: C({
    backstory:
    ...
    speech:
      "Anxious, over-qualified, parenthetical. Cites document numbers. Apologises for facts as he delivers them.",
    voice: { pitch: 1.22, rate: 1.2, prefer: "male", hints: ["fred", "alex"] },
    lines: {
      hostile:
        '"I... no. No. I have written down what you did, and the copy is not here, and that is all I will say."',
      cold: '"Please don\'t stand so close to the papers. Some of them are the only ones."',
      neutral:
        '"Entry forty-one. Two hundred bushels to a village with, ah, eleven households. Someone was being fed, but not with grain."',
      warm: '"I kept a second copy for you. That is... that is a very great deal of trust, from me, about paper."',
      devoted:
        '"Everything in the sack is yours. Hang someone with it. Preferably alphabetically."',
    },
  }),
};
...
export function voiceOf(npcId: string | undefined, fallbackSeed = ""): VoiceProfile {
  ...
  if (c) {
    ...
    return {
      ...
      apiVoice:
        c.voice.apiVoice ??
        pick(c.voice.prefer === "male" ? STUDIO_MALE : STUDIO_FEMALE, npcId ?? "x"),
      direction:
        c.voice.direction ??
        `${c.speech} Medieval low-fantasy setting; stay in character as ${NPCS[npcId ?? ""]?.name ?? "this character"}.`,
    };
  }
  const seed = (npcId ?? fallbackSeed).split("").reduce((a, ch) => a + ch.charCodeAt(0), 0);
  return {
    pitch: 0.8 + (seed % 9) * 0.06,
    rate: 0.88 + (seed % 5) * 0.05,
    prefer: seed % 2 ? "male" : "female",
  };
}
