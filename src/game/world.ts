...
export const NPCS: Record<string, Npc> = Object.fromEntries(
  (
    [
      { id: "lord_corvane", name: "Aldric Corvane", title: "Lord of Ravensfell", role: "lord", faction: "ravensfell", portrait: "🧔‍♂️", personality: "Weary, principled, allergic to flattery.", home: "corvane_keep", blurb: "Holds the loyalist claim and knows exactly what it costs." },
      { id: "lady_seren", name: "Seren Corvane", title: "Heir of Ravensfell", role: "heir", faction: "ravensfell", portrait: "👩‍🦰", personality: "Dry wit, ruthless strategist, terrible at small talk.", eligible: true, home: "corvane_keep", blurb: "Would run the war better than her father and everyone knows it." },
      { id: "lord_vantry", name: "Hollis Vantry", title: "Lord Treasurer of Goldmere", role: "lord", faction: "goldmere", portrait: "🤵", personality: "Genial, transactional, never says no directly.", home: "vantry_hall", blurb: "Funds both sides and calls it prudence." },
      { id: "ser_isolde", name: "Ser Isolde Marr", title: "Sword of Goldmere", role: "retainer", faction: "goldmere", portrait: "🤺", personality: "Blunt, loyal to contracts, secretly sentimental.", eligible: true, home: "vantry_hall", blurb: "Paid to fight, stays for the reasons." },
      { id: "lord_draeven", name: "Corvus Draeven", title: "Hammer of the Iron Pact", role: "usurper", faction: "ironpact", portrait: "👺", personality: "Charming, patient, absolutely certain he is the cure.", home: "draeven_hold", blurb: "The usurper. Believes the realm is a broken tool he can reforge." },
      { id: "captain_maud", name: "Maud Kell", title: "Captain of the Ash Company", role: "retainer", faction: "ironpact", portrait: "🪖", personality: "Professional, grim, funnier than she intends.", home: "draeven_hold", blurb: "Draeven's lieutenant. Follows orders until the day she doesn't." },
      { id: "the_fen_widow", name: "The Fen Widow", title: "Draeven's Whisper", role: "rogue", faction: "ironpact", portrait: "🕸", personality: "Soft-spoken, poisonous, oddly polite.", home: "draeven_hold", blurb: "Nobody agrees on her real name. Everyone agrees on her results." },
      { id: "lady_aleyne", name: "Ysolt Aleyne", title: "Lady of Sunmarch", role: "lord", faction: "sunmarch", portrait: "👸", personality: "Immaculate manners, duelling scars, zero patience.", eligible: true, home: "aleyne_citadel", blurb: "Rides at the front and expects you to keep up." },
      { id: "ser_perrin", name: "Ser Perrin Hale", title: "Master of Horse", role: "retainer", faction: "sunmarch", portrait: "🐴", personality: "Cheerful, gossipy, deadly with a lance.", home: "aleyne_citadel", blurb: "Knows every scandal in the realm and shares most of them." },
      { id: "lord_brannoc", name: "Gwyth Brannoc", title: "Chieftain of Thornwold", role: "lord", faction: "thornwold", portrait: "🧔", personality: "Suspicious of walls, roads, and promises.", home: "brannoc_stockade", blurb: "Speaks for thirty clans who agree on nothing." },
      { id: "hana_of_the_glen", name: "Hana of the Glen", title: "Bow of Thornwold", role: "retainer", faction: "thornwold", portrait: "🏹", personality: "Quiet, wry, watches everything.", eligible: true, home: "brannoc_stockade", blurb: "Could end the war with one arrow and won't, on principle." },
      { id: "reeve_ilsa", name: "Ilsa Farr", title: "First Reeve of the Free Holds", role: "lord", faction: "freeholds", portrait: "🧑‍⚖️", personality: "Pragmatic, sardonic, allergic to titles.", home: "cassock_town", blurb: "Runs the charter towns by exhausting everyone else in the room." },
      { id: "osrick_quill", name: "Osrick Quill", title: "Disgraced Clerk", role: "commoner", faction: "freeholds", portrait: "📜", personality: "Nervous, precise, hoards receipts like relics.", home: "cassock_town", blurb: "Kept copies of the ledgers that could hang a lord." },
      { id: "bram_carter", name: "Bram Carter", title: "Carter of Oakhollow", role: "commoner", faction: "ravensfell", portrait: "🧑‍🌾", personality: "Relentlessly cheerful, dreadful singer.", home: "oakhollow", blurb: "The first person in the realm to do you a favour." },
      { id: "sister_dulcie", name: "Sister Dulcie", title: "Keeper of the Oakhollow Shrine", role: "cleric", faction: null, portrait: "✚", personality: "Kind, blunt, keeps a knife under the altar cloth.", home: "oakhollow", blurb: "Mends bodies, then tells them exactly what they did wrong." },
    ] as Npc[]
  ).map((n) => [n.id, n]),
);
